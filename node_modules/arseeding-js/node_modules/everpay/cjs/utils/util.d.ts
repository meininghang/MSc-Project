...
export declare const getTokenBySymbol: (symbol: string, tokenList?: Token[] | undefined) => Token | undefined;
export declare const getTokenByTag: (tag: string, tokenList?: Token[] | undefined) => Token | undefined;
export declare const isArweaveChainPSTMode: (token?: Token | undefined) => boolean;
