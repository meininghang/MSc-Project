...
class Uploader {
    ...
    async upload(data, tags) {
        ...
        const dataItem = (0, arseeding_arbundles_1.createData)(data, signer, { tags, anchor: crypto_1.default.randomBytes(32).toString("base64").slice(0, 32) });
    ...
    async processItem(item) {
        ...
        if (Buffer.isBuffer(item)) {
            const signer = await this.currencyConfig.getSigner();
            item = (0, arseeding_arbundles_1.createData)(item, signer, { anchor: crypto_1.default.randomBytes(32).toString("base64").slice(0, 32) });
